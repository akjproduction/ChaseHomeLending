...
public class ReusableMethodsLoggersPageObject {
    ...
    public static void mouseClick(WebDriver driver, WebElement locator, ExtentTest logger, String elementName) {
        ...
        try {
            ...
            logger.log(LogStatus.FAIL, "Unable to capture text on element " + e);
        }
    }//end of click method

    //method to click on an element
    public static void mouseHover(WebDriver driver, WebElement locator, ExtentTest logger, String elementName) {
        WebDriverWait wait = new WebDriverWait(driver, 10);
        Actions actions = new Actions(driver);
        try {
